...
export default createRule<[], 'forbidden'>({
  name: 'no-regexp-unicode-property-escapes',
  meta: {
    type: 'problem',
    docs: { description: 'disallow RegExp Unicode property escape sequences.', recommended: false },
    schema: [],
    messages: { forbidden: 'ES2018 RegExp Unicode property escape sequences are forbidden.' },
  },
  defaultOptions: [],
  create(context) {
    return {
