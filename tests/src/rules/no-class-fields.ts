  ...
  fn() {
    ...
    A.#d();
        ...
        errors: [
          ...
          { ...error('private access #c'), line: 6, column: 9 },
          { ...error('private access #c'), line: 7, column: 13 },
          { ...error('private access #c'), line: 8, column: 9 },
          { ...error('private access #c'), line: 9, column: 9 },
          { ...error('private method call #d()'), line: 10, column: 9 },
        ],
      },
    ],
  });
